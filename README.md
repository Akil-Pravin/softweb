...
```
## OUTPUT:
![alt text](<pravin/softapp/static/Screenshot (8).png>)
![alt text](<pravin/softapp/static/Screenshot (9).png>)
![alt text](<pravin/softapp/static/Screenshot (10).png>)
![alt text](<pravin/softapp/static/Screenshot (11).png>)
![alt text](<pravin/softapp/static/Screenshot (12).png>)
## RESULT:
